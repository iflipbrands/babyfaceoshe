(function(){
  ...
  toggle?.addEventListener('click',()=>{
    ...
    if(audio.paused){showNowPlaying(currentItem||playerPlaylist[playlistIndex]);audio.play().catch(()=>{playerLabel.textContent='CHECK AUDIO FILE / PATH';setPlayState(false)})}else audio.pause();
  });
